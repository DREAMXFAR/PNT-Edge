...
if __name__ == "__main__":
    # f = open(r"../cityscapes-preprocess/data_proc/train.txt", 'r')
    # lines = f.readlines()
    # root_folder = r"../cityscapes-preprocess/data_proc/"

    f = open(r"./seal-master/data/sbd-preprocess/", 'r')
    lines = f.readlines()
    root_folder = r"../cityscapes-preprocess/data_proc/"

    if "cityscapes" in root_folder:
        ...
        for ori_line in tqdm(lines):
            ...
            convert_num_to_bitfield(label_data, h, w, npz_name, root_folder, h5_file, cls_num=19)
